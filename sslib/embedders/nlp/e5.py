...
class E5Embedder(BaseEmbedder):
    ...
    def __init__(self, model_name: str = "multilingual-e5-base", 
                 device: str = "cpu", normalize: bool = True, **kwargs):
    ...
    def embed_texts(self, texts: list, max_length: int = 512, 
                   task_instruction: Optional[str] = None) -> torch.Tensor:
    ...
    def embed_queries_and_documents(self, queries: list, documents: list,
                                   task_instruction: Optional[str] = None) -> tuple:

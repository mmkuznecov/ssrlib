...
class Food101Dataset(HFDatasetMixin, BaseDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super().__init__("Food101", **kwargs)

        self.split = split
        self.cache_dir = cache_dir

        # Get dataset info from registry
        self.hf_info = get_hf_dataset_info("food101")
    ...
    def download(self) -> None:
        ...
        logger.info(f"Loading Food101 dataset (split: {self.split})")
        print(f"Loading Food101 dataset (split: {self.split})")
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"Food101Dataset(split='{self.split}', "
